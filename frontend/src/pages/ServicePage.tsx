      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
            ...
            <div className="relative">
              ...
              <textarea
                {...register("LocationDescription", {
                  ...
                  minLength: {
                    value: 10,
                    message: "Please be more specific (min 10 chars)",
                  },
                })}
                rows={3}
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <strong className="text-slate-600">2 hours</strong> to confirm. You
...
const ServicePage: React.FC = () => {
  ...
  const colorClass = service
    ? (SERVICE_COLORS[service.Title] ?? "from-primary-500 to-navy-700")
    : "";
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="container-custom pb-16">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-4">
                    {[
                      ...
                      <div
                        key={label}
                        className="bg-white rounded-xl p-3 text-center shadow-card border border-slate-100"
                      >
                        ...
                        <p className="text-xs font-700 text-navy-900">
                          {label}
                        </p>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-5 flex items-start gap-3 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3">
                    ...
                    <p className="text-xs text-amber-800 leading-relaxed">
                      <strong>Free site assessment</strong> — our technician
                      will visit your property, assess your needs, and provide a
                      no-obligation quote before any work begins.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      step: "01",
                      title: "Book Online",
                      desc: "Submit your booking request with your preferred date and location.",
                    },
                    {
                      step: "02",
                      title: "We Confirm",
                      desc: "Our team calls you within 2 hours to confirm and discuss your requirements.",
                    },
                    {
                      step: "03",
                      title: "Site Visit",
                      desc: "A certified technician visits, assesses the job, and gives a final quote.",
                    },
                    {
                      step: "04",
                      title: "Job Complete",
                      desc: "We complete the installation or repair to the highest standards.",
                    },
                  ].map(({ step, title, desc }) => (
                    <div key={step} className="relative text-center">
                      ...
                      <h4 className="font-display font-700 text-navy-900 text-sm mb-1.5">
                        {title}
                      </h4>
              ...
              {/* ── CTA banner ── */}
              <div
                className="mt-14 relative overflow-hidden rounded-3xl p-10 text-center"
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/70 mb-7 max-w-lg mx-auto text-sm">
                    Book your {service.Title} today. Free site assessment,
                    no-obligation quote.
                  </p>
                  <button
                    onClick={() => setShowBooking(true)}
