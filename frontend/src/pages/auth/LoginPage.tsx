...
const LoginPage: React.FC = () => {
  ...
  // ?redirect=/profile etc. — honour after login
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "linear-gradient(135deg,#080f28 0%,#133889 100%)" }}>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 xs:p-8 md:p-10">
            <div className="mb-6 xs:mb-8">
              <h1 className="font-display text-2xl xs:text-3xl font-700 text-navy-900 mb-1">Welcome back</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 xs:space-y-5" noValidate>
              <div>
