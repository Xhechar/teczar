      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        >
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-200"
            style={{ background: "linear-gradient(135deg,#1660eb,#0d1a42)" }}
          >
          ...
          <button
            onClick={() => navigate(`/services/${service.ServiceId}`)}
            className="flex items-center justify-center px-3 py-2.5 rounded-xl border-2 border-slate-200 text-slate-500 hover:border-primary-400 hover:text-primary-600 transition-all duration-200"
            title="View details"
          >
